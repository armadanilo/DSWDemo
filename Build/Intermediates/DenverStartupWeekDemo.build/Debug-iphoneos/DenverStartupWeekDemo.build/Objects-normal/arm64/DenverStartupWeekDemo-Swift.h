...
@property (nonatomic) IBOutlet UIImageView * __null_unspecified mapSnapshot;
@property (nonatomic) IBOutlet UIActivityIndicatorView * __null_unspecified loadingSpinner;
- (void)viewDidLoad;
